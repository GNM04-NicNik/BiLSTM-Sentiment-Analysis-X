...
<p align="justify">Gambar berikut menunjukkan dengan jelas adanya *imbalanced* pada data. 
<img width="790" height="490" alt="image" src="https://github.com/user-attachments/assets/233367bc-8e36-4411-87a8-3ea0e04a6a47" />  
Tweet dengan label ‘Bad’ ada sekitar 49.2%, ‘Neutral’ ada sekitar 25.3%, dan label ‘Good’ ada sekitar 25.5%. Oleh sebab itu,  metode *Synthetic Minority Over-sampling* (SMOTE) digunakan untuk menyeimbangkan distribusi labelnya.</p>  
